...
<!-- ErpdataroomListView.jsp 추가분 -->		
	...
	<% if(dataroom.getDataroomOriginalFileName() != null){ %>
		<a href="/NHMP/drfdown?ofile=<%= dataroom.getDataroomOriginalFileName() %>&rfile=<%= dataroom.getDataroomRenameFileName() %>"><%= dataroom.getDataroomOriginalFileName() %></a>
	...
	<tr><th colspan="4">
		...
		<a href="/NHMP/drupview?no=<%=dataroom.getDataroomNo()%>&page=<%= currentPage %>">수정페이지로 이동</a> 	&nbsp; 
		<a href="/NHMP/drlist.ad">목록으로 이동</a>		&nbsp; 
		<a href="/NHMP/drdel.ad?no=<%= dataroom.getDataroomNo() %>">삭제하기</a>	&nbsp; 
