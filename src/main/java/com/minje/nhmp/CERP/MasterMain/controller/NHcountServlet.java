...
/**
 * Servlet implementation class NHcountServlet
 */
@WebServlet("/NHcnt")
public class NHcountServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NHcountServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String NHcnt = new NHService().NHcount(loginHospital);
		System.out.println(NHcnt);
