...
// 직렬화
public class DataroomVo implements java.io.Serializable {
	...
	public DataroomVo(int dataroomNo, String dataroomTitle, String dataroomContent, String dataroomOriginalFileName,
