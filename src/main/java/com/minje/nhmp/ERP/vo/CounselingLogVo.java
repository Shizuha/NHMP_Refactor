...
public class CounselingLogVo implements java.io.Serializable{
	...
	public CounselingLogVo () {}

	public CounselingLogVo(int clNo, String clTitle, java.sql.Date clDate, String clContents, String clPhone, String clComment, String clPatName,
									String clEmpName) {
		super();
		this.clNo = clNo;
