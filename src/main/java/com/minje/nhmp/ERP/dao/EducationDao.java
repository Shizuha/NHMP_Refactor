...
public class EducationDao {
	...
	public int insertEdu(Connection conn, EducationVo e) {
		int result = 0;
	...
	public ArrayList<EducationVo> selectList(Connection conn, String empId) {
	...
	public int updateEdu(Connection conn, EducationVo e, String eduCode) {
		int result = 0;
		PreparedStatement pstmt = null;
