<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="Main.vo.NursingHospitalVo,ERP.Employee.model.vo.Employee"%>
<%
...
<head>
    ...
    <link rel="stylesheet" href='/NHMP/resources/ERP/FullCaldendar/vendor/css/bootstrap-datetimepicker.min.css' />

    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Open+Sans:400,500,600">
    <link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">

    <link rel="stylesheet" href="/NHMP/resources/ERP/FullCaldendar/css/main.css">
...
<body>
    ...
    <script src="/NHMP/resources/ERP/FullCaldendar/vendor/js/fullcalendar.min.js"></script>
    <script src="/NHMP/resources/ERP/FullCaldendar/vendor/js/ko.js"></script>
    <script src="/NHMP/resources/ERP/FullCaldendar/vendor/js/select2.min.js"></script>
    <script src="/NHMP/resources/ERP/FullCaldendar/vendor/js/bootstrap-datetimepicker.min.js"></script>
    <script src="/NHMP/resources/ERP/FullCaldendar/js/main.js"></script>
    <script src="/NHMP/resources/ERP/FullCaldendar/js/addEvent.js"></script>
    <script src="/NHMP/resources/ERP/FullCaldendar/js/editEvent.js"></script>
    <script src="/NHMP/resources/ERP/FullCaldendar/js/etcSetting.js"></script>
</body>
</html>