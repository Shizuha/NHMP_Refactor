...
<script type="text/javascript">
function moveupdate(){
	location.href = "/NHMP/views/ERP/counselingLog/CounselingLogUpdateView.jsp";
	return false;
}
function movedelete(){
 ...
 %>
        ...
        ***********************************-->
		<div class="content-body" align="center" style="padding: 40px;">
			<h2 align="center">환자 상담일지 상세조회 페이지</h2>
			<form action="/NHMP/counseldetail" method="post"
				enctype="multipart/form-data">
				<table style="align:'center'; width:'800'; cellspacing:'0'; cellpadding:'5'; border:'3'">
					<tr>
						<th style="font-size: 16px;">상담일지번호</th>
						<td style="font-size: 16px;"><%=counselingLog.getClNo()%></td>
					</tr>
					<tr>
						<th style="font-size: 16px;">제목</th>
						<td style="font-size: 16px;"><%=counselingLog.getClTitle()%></td>
					</tr>
					<tr>
						<th style="font-size: 16px;">날짜</th>
						<td style="font-size: 16px;"><%=counselingLog.getClDate()%></td>
					</tr>
					<tr>
						<th style="font-size: 16px;">내용</th>
						<td style="font-size: 16px;"><%=counselingLog.getClContents()%></td>
					</tr>
					<tr>
						<th style="font-size: 16px;">연락처</th>
						<td style="font-size: 16px;"><%=counselingLog.getClPhone()%></td>
					</tr>
					<tr>
						<th style="font-size: 16px;">비고</th>
						<td style="font-size: 16px;"><%=counselingLog.getClComment()%></td>
					</tr>
					<tr>
						<th style="font-size: 16px;">환자명</th>
						<td style="font-size: 16px;"><%=counselingLog.getClPatName()%></td>
					</tr>
					<tr>
						<th style="font-size: 16px;">상담자</th>
						<td style="font-size: 16px;"><%=counselingLog.getClEmpName()%></td>
					</tr>
					<tr>
