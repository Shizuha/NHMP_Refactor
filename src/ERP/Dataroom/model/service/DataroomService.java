...
public class DataroomService {
	...
	//리스트보기(관리자)
	public ArrayList<Dataroom> selectList(int startRow, int endRow, NursingHospitalVo loginHospital) {
		String userid = loginHospital.getNH_USERID();
		String userpwd = loginHospital.getNH_USERPWD();
		Connection conn = getConnection(userid, userpwd);
	...
	//자료실 게시글 상세처리(관리자)
	public Dataroom selectOne(String dataroomNo, NursingHospitalVo loginHospital) {
		String userid = loginHospital.getNH_USERID();
		String userpwd = loginHospital.getNH_USERPWD();
		Connection conn = getConnection(userid, userpwd);
	...
	//자료실 글작성
	public int insertDataroom(Dataroom dataroom, NursingHospitalVo loginHospital) {
		String userid = loginHospital.getNH_USERID();
		String userpwd = loginHospital.getNH_USERPWD();
		Connection conn = getConnection(userid, userpwd);
	...
	public int updateBoard(Dataroom dataroom, NursingHospitalVo loginHospital) {
		String userid = loginHospital.getNH_USERID();
		String userpwd = loginHospital.getNH_USERPWD();
		Connection conn = getConnection(userid, userpwd);
	...
	//재목검색 서비스(관리자)
	public ArrayList<Dataroom> selectTitleSearch(String keyword, NursingHospitalVo loginHospital) {
		String userid = loginHospital.getNH_USERID();
		String userpwd = loginHospital.getNH_USERPWD();
		Connection conn = getConnection(userid, userpwd);
	...
	//작성자검색(관리자)
	public ArrayList<Dataroom> selectWriterSearch(String keyword, NursingHospitalVo loginHospital) {
		String userid = loginHospital.getNH_USERID();
		String userpwd = loginHospital.getNH_USERPWD();
		Connection conn = getConnection(userid, userpwd);
