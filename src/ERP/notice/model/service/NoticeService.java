...
public class NoticeService {
	...
	//공지사항 전체보기
	public ArrayList<Notice> selectAll(NursingHospitalVo loginHospital){
		//아이디랑 비밀번호로 게시판 구분
	...
	//게시글 상세처리
	public Notice selectOne(String noticeNo, NursingHospitalVo loginHospital) {
	...
	public ArrayList<Notice> selectList(int startRow, int endRow, NursingHospitalVo loginHospital) {
	...
	//글쓰기
	public int insertNotice(Notice notice, NursingHospitalVo loginHospital) {
	...
	//공지사항 수정
	public int updateNotice(Notice notice, NursingHospitalVo loginHospital) {
	...
	//제목검색 서비스(관리자)
	public ArrayList<Notice> selectTitleSearch(String keyword, NursingHospitalVo loginHospital) {
	...
	//작성자검색(관리자)
	public ArrayList<Notice> selectWriterSearch(String keyword, NursingHospitalVo loginHospital) {
	...
	//날짜검색(관리자)
	public ArrayList<Notice> selectDateSearch(Date from, Date to, NursingHospitalVo loginHospital) {
