...
/**
 * Servlet implementation class MedicienRecordFileDownServlet
 */
@WebServlet("/recordfdown")
public class MedicienRecordFileDownServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MedicienRecordFileDownServlet() {
        super();
