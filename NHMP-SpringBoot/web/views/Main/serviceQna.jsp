		...
		<div id="indiv">
			...
			<table style="width: 100%; border-top: 1px solid #444444; border-collapse: collapse;">
				<tr>
					...
					<th
						style="border-bottom: 1px solid #444444; padding: 10px; text-align: center; background-color: #bbdefb;">문의 제목</th>
					<th
				...
				<td style="border-bottom: 1px solid #444444; padding: 10px; text-align: center; background-color: #e3f2fd;">
					<a href="/NHMP/detailqna?no=<%= q.getQNA_NO() %>"><%= q.getQNA_TITLE() %></a>
					</td>
				<td style="border-bottom: 1px solid #444444; padding: 10px; text-align: center; background-color: #e3f2fd;">
					<%= q.getQNA_TYPE() %>
					</td>
			...
			<div style="max-width:800px; margin: auto;text-align: center;">
			  <ul class="pagination pagination-lg" style="justify-content: center;">
			    ...
			    <li class="page-item disabled">
			      <a class="page-link" href="/NHMP/allqna?page=1">&laquo;</a>
			     <% }else{ %>
			      <a class="page-link" href="/NHMP/allqna?page=<%= beginPage - 10 %>">&laquo;</a>
			    </li>
			    <% } %>
			    ...
			    <li class="page-item active">
			      <a class="page-link" href="/NHMP/allqna?page=<%= p %>"><b><%= p %></b></a>
			    </li>
			    <% } else { %>
			    <li class="page-item">
			      <a class="page-link" href="/NHMP/allqna?page=<%= p %>"><%= p %></a>
			    </li>
			    <% }} %>
			    <% if((endPage + 10) > maxPage){ %>
			    <li class="page-item">
			      <a class="page-link" href="/NHMP/allqna?page=<%= maxPage %>">&raquo;</a>
			    </li>
			    <% }else{ %>
			    <li class="page-item">
			      <a class="page-link" href="/NHMP/allqna?page=<%= endPage + 10 %>">&raquo;</a>
			    </li>
			    <% } %>
			  </ul>
			  <a href="/NHMP/views/Main/serviceQnaInsert.jsp"><button type="button" class="btn btn-primary">QNA 등록</button></a>
		  </div>
		</div>
